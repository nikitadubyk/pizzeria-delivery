  ...
  return baseQuery(
    {
      ...args,
      headers:
        token && args.url !== URL.RESTAURANT_LOGIN
...
export const restaurantAuthApi = createApi({
  ...
  tagTypes: ["Category", "Product", "RestaurantSettings"],
  endpoints: (builder) => ({
...
export const { useLoginRestaurantMutation, useGetRestaurantMeQuery } =
  restaurantAuthApi;
